...
`)}indentComponentAttribute(e,t){if(r.isEmpty(e))return t;if(this.isInline(t))return`${t}`;if(this.isInline(t)&&/\S/.test(e))return`${t}`;let i=v(e).amount/this.indentSize,s=this.indentCharacter.repeat(i<0?0:i*this.indentSize),a=t.split(`
`);return r.chain(a).map((l,o)=>o===0?l.trim():s+l).value().join(`
...
`).value()}restoreBladeDirectivesInStyles(e){return r.replace(e,/(?<=<style[^>]*?(?<!=)>)(.*?)(?=<\/style>)/gis,t=>{let n=t,i=new RegExp(`${this.getBladeDirectiveInStylePlaceholder("(\\d+)")} {\\s*?/\\* inline_directive \\*/\\s*?}`,"gmi");n=r.replace(n,i,(o,c)=>this.bladeDirectivesInStyle[c]);let s=new RegExp(`}\\s*?${this.getBladeDirectiveInStylePlaceholder("(\\d+)")} {\\s*?/\\*else\\*/`,"gmi");n=r.replace(n,s,(o,c)=>`${this.bladeDirectivesInStyle[c]}`);let a=new RegExp(`${this.getBladeDirectiveInStylePlaceholder("(\\d+)")} {\\s*?/\\*start\\*/`,"gmi");n=r.replace(n,a,(o,c)=>`${this.bladeDirectivesInStyle[c]}`);let l=new RegExp(`}\\s*?/\\* ${this.getBladeDirectiveInStylePlaceholder("(\\d+)")} \\*/`,"gmi");return n=r.replace(n,l,(o,c)=>`${this.bladeDirectivesInStyle[c]}`),n})}restoreBladeDirectivesInScripts(e){let t=new RegExp(`${this.getBladeDirectivePlaceholder("(\\d+)")}`,"gm"),n=r.replace(e,t,(i,s)=>{var c;let a=this.getBladeDirectivePlaceholder(s.toString()),l=(c=e.match(new RegExp(`^(.*?)${a}`,"gmi")))!=null?c:[""],o=v(l[0]);return this.indentBladeDirectiveBlock(o,this.bladeDirectives[s])});return n=r.replace(n,/(?<=<script[^>]*?(?<!=)>)(.*?)(?=<\/script>)/gis,i=>{let s=i;return s=r.replace(s,new RegExp(`if \\( \\/\\*(?:(?:${this.getBladeDirectiveInScriptPlaceholder("(\\d+)")}).*?)\\*\\/ \\) \\{`,"gis"),(a,l)=>`${this.directivesInScript[l]}`),s=r.replace(s,new RegExp(`} \\/\\* (?:${this.getBladeDirectiveInScriptPlaceholder("(\\d+)")}) \\*\\/ {(\\s*?\\(___directive_condition_\\d+___\\))?`,"gim"),(a,l,o)=>r.isUndefined(o)?`${this.directivesInScript[l].trim()}`:`${this.directivesInScript[l].trim()} ${(o!=null?o:"").trim()}`),s=r.replace(s,new RegExp(`} \\/\\*(?:${this.getBladeDirectiveInScriptPlaceholder("(\\d+)")})\\*\\/`,"gis"),(a,l)=>`${this.directivesInScript[l]}`),s=r.replace(s,new RegExp(`${this.getRawPlaceholder("(\\d+)")}`,"gm"),(a,l)=>{var u;let o=this.rawBlocks[l],c=this.getRawPlaceholder(l.toString()),d=(u=e.match(new RegExp(`^(.*?)${c}`,"gmi")))!=null?u:[""],p=v(d[0]);return this.isInline(o)&&this.isMultilineStatement(o)?o=D(`<?php
${o}
?>`,this.options).trim():o.split(`
`).length>1?o=D(`<?php${o}?>`,this.options).trim():o=`<?php${o}?>`,r.replace(o,/^(\s*)?<\?php(.*?)\?>/gms,(g,$,w)=>{if(this.isInline(o))return`@php${w}@endphp`;let C=this.preserveStringLiteralInPhp(w),Be=this.indentRawBlock(p,C);return`@php${this.restoreStringLiteralInPhp(Be)}@endphp`})}),s=r.replace(s,/(?<=[\S]+)(\s*?)\/\*\*\*script_placeholder\*\*\*\/(\s)?/gim,(a,l,o)=>{if(o!==void 0)return o;let c=l!=null?l:"",d=o!=null?o:"";return c+d}),s}),t.test(n)&&(n=this.restoreBladeDirectivesInScripts(n)),n}async formatPreservedBladeDirectives(e){return Ne.map(e,async t=>{let n=await this.formatAsHtml(t);return(await this.formatAsBlade(n)).trimRight(`
`)})}restoreBladeComment(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getBladeCommentPlaceholder("(\\d+)")}`,"gms"),(n,i)=>this.bladeComments[i].replace(/{{--(?=\S)/g,"{{-- ").replace(/(?<=\S)--}}/g," --}}")))}restorePhpComment(e){return r.replace(e,new RegExp(`${this.getPhpCommentPlaceholder("(\\d+)")};{0,1}`,"gms"),(t,n)=>{var o;let i=this.getPhpCommentPlaceholder(n.toString()),s=(o=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?o:[""],a=v(s[0]),l=re(this.phpComments[n]);return this.indentPhpComment(a,l)})}async restoreEscapedBladeDirective(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getEscapedBladeDirectivePlaceholder("(\\d+)")}`,"gms"),(n,i)=>this.escapedBladeDirectives[i]))}restoreBladeBrace(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getBladeBracePlaceholder("(\\d+)")}`,"gm"),(n,i)=>{var c;let s=this.getBladeBracePlaceholder(i.toString()),a=(c=e.match(new RegExp(`^(.*?)${s}`,"gmi")))!=null?c:[""],l=v(a[0]),o=this.bladeBraces[i];return o.trim()===""?`{{${o}}}`:this.isInline(o)?`{{ ${x(o,{...this.options,trailingCommaPHP:!1,printWidth:L}).replace(/([\n\s]*)->([\n\s]*)/gs,"->").split(`
`).map(d=>d.trim()).join("").trimRight(`
`)} }}`:`{{ ${this.indentRawPhpBlock(l,x(o,this.options).replace(/([\n\s]*)->([\n\s]*)/gs,"->").trim().trimRight(`
`))} }}`}))}restoreRawBladeBrace(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getRawBladeBracePlaceholder("(\\d+)")}`,"gms"),(n,i)=>{var c;let s=this.getRawBladeBracePlaceholder(i),a=(c=e.match(new RegExp(`^(.*?)${s}`,"gmi")))!=null?c:[""],l=v(a[0]),o=this.rawBladeBraces[i];return o.trim()===""?`{!!${o}!!}`:this.indentRawPhpBlock(l,`{!! ${x(o,this.options).replace(/([\n\s]*)->([\n\s]*)/gs,"->").trim()} !!}`)}))}restoreInlineDirective(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getInlinePlaceholder("(\\d+)")}`,"gms"),(n,i)=>this.inlineDirectives[i]))}restoreConditions(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getConditionPlaceholder("(\\d+)")}`,"gms"),(n,i)=>{var c;let s=this.getConditionPlaceholder(i),a=(c=e.match(new RegExp(`^(.*?)${s}`,"gmi")))!=null?c:[""],l=v(a[0]),o=this.conditions[i];return this.formatExpressionInsideBladeDirective(o,l)}))}restoreUnbalancedDirective(e){return new Promise(t=>t(e)).then(t=>r.replace(t,/@if \(unbalanced___(\d+)___\)/gms,(n,i)=>this.unbalancedDirectives[i]))}restoreInlinePhpDirective(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getInlinePhpPlaceholder("(\\d+)")}`,"gm"),(n,i)=>{var c;let s=this.inlinePhpDirectives[i],a=this.getInlinePhpPlaceholder(i),l=(c=e.match(new RegExp(`^(.*?)${a}`,"gmi")))!=null?c:[""],o=v(l[0]);return s.includes("@php")?`${x(s,{...this.options,printWidth:L}).replace(/([\n\s]*)->([\n\s]*)/gs,"->").trim().trimRight(`
`)}`:new RegExp(Z.join("|"),"gi").test(s)?r.replace(s,new RegExp(`(?<=@(${r.map(Z,p=>p.substring(1)).join("|")}).*?\\()(.*)(?=\\))`,"gis"),(p,u,g)=>{let $=this.wrapLineLength;return["button","class"].includes(u)&&($=80),u==="include"&&($=this.wrapLineLength-4-i.length-o.amount),this.formatExpressionInsideBladeDirective(g,o,$)}):`${x(s,{...this.options,printWidth:L}).trimEnd()}`}))}restoreRawPhpTags(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getRawPhpTagPlaceholder("(\\d+)")}`,"gms"),(n,i)=>{var s;try{let a=this.rawPhpTags[i],o=/(?<=<\?php\s*?)\/\*.*?\*\/(?=\s*?\?>)/gim.test(a)&&this.isInline(a),c=this.getRawPhpTagPlaceholder(i),d=(s=e.match(new RegExp(`^(.*?)${c}`,"gmi")))!=null?s:[""],p=v(d[0]);if(o)return a;let u=D(this.rawPhpTags[i],this.options).trim().trimRight(`
`);if(this.isInline(u))return u;let g=this.preservePhpComment(u);return p.indent&&(g=this.indentRawPhpBlock(p,g)),this.restorePhpComment(g)}catch{return`${this.rawPhpTags[i]}`}}))}restoreNonnativeScripts(e){return r.replace(e,new RegExp(`${this.getNonnativeScriptPlaceholder("(\\d+)")}`,"gmi"),(t,n)=>`${this.nonnativeScripts[n]}`)}restoreScripts(e){return new Promise(t=>t(e)).then(t=>r.replace(t,new RegExp(`${this.getScriptPlaceholder("(\\d+)")}`,"gim"),(n,i)=>{var p;let s=this.scripts[i],a=this.getScriptPlaceholder(i),l=(p=e.match(new RegExp(`^(.*?)${a}`,"gmi")))!=null?p:[""],o=v(l[0]),c=f(this.options).useTabs||!1,d={indent_size:f(this.options).indentSize||4,wrap_line_length:f(this.options).wrapLineLength||120,wrap_attributes:f(this.options).wrapAttributes||"auto",wrap_attributes_min_attrs:f(this.options).wrapAttributesMinAttrs,indent_inner_html:f(this.options).indentInnerHtml||!1,extra_liners:f(this.options).extraLiners,indent_with_tabs:c,end_with_newline:!1,templating:["php"]};return c?this.indentScriptBlock(o,r.replace(E.html_beautify(s,d),/\t/g,"	".repeat(this.indentSize))):this.indentScriptBlock(o,E.html_beautify(s,d))}))}async restoreCustomDirective(e){return this.restoreInlineCustomDirective(e).then(t=>this.restoreBeginCustomDirective(t)).then(t=>this.restoreElseCustomDirective(t)).then(t=>this.restoreEndCustomDirective(t))}async restoreInlineCustomDirective(e){return r.replace(e,new RegExp(`${this.getInlineCustomDirectivePlaceholder("(\\d+)")}`,"gim"),(t,n)=>{var o;let i=this.getInlineCustomDirectivePlaceholder(n.toString()),s=(o=e.match(new RegExp(`^(.*?)${r.escapeRegExp(i)}`,"gmi")))!=null?o:[""],a=v(s[0]),l=`${this.customDirectives[n]}`;return r.replace(l,/(@[a-zA-z0-9\-_]+)(.*)/gis,(c,d,p)=>{try{let u=x(`func${p}`,{...this.options,printWidth:L}).replace(/([\n\s]*)->([\n\s]*)/gs,"->").replace(/,(\s*?\))$/gm,(g,$)=>$).trim().substring(4);return`${d}${this.indentComponentAttribute(a.indent,u)}`}catch{return`${c}`}})})}async restoreBeginCustomDirective(e){return r.replace(e,new RegExp(`@customdirective\\(___(\\d+)___\\)\\s*?(${y})*`,"gim"),(t,n)=>{var o;let i=this.getBeginCustomDirectivePlaceholder(n.toString()),s=(o=e.match(new RegExp(`^(.*?)${r.escapeRegExp(i)}`,"gmi")))!=null?o:[""],a=v(s[0]),l=`${this.customDirectives[n]}`;return r.replace(l,/(@[a-zA-z0-9\-_]+)(.*)/gis,(c,d,p)=>{try{let u=x(`func${p}`,{...this.options,trailingCommaPHP:!1}).replace(/([\n\s]*)->([\n\s]*)/gs,"->").trim().substring(4);return`${d}${this.indentComponentAttribute(a.indent,u)}`}catch{return`${c}`}})})}async restoreElseCustomDirective(e){return r.replace(e,/@else\(___(\d+)___\)/gim,(t,n)=>`${this.customDirectives[n]}`)}async restoreEndCustomDirective(e){return r.replace(e,/@endcustomdirective\(___(\d+)___\)/gim,(t,n)=>`${this.customDirectives[n]}`)}async restoreHtmlTags(e){return r.replace(e,new RegExp(`${this.getHtmlTagPlaceholder("(\\d+)")}`,"gim"),(t,n)=>{var p;let i=this.getHtmlTagPlaceholder(n.toString()),s=(p=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?p:[""],a=v(s[0]),l={indent_size:f(this.options).indentSize||4,wrap_line_length:f(this.options).wrapLineLength||120,wrap_attributes:f(this.options).wrapAttributes||"auto",wrap_attributes_min_attrs:f(this.options).wrapAttributesMinAttrs,indent_inner_html:f(this.options).indentInnerHtml||!1,extra_liners:f(this.options).extraLiners,end_with_newline:!1,templating:["php"]},o=this.htmlTags[n],c=r.first(o.match(/(<(textarea|pre).*?(?<!=)>)(?=.*?<\/\2>)/gis));if(c===void 0)return`${this.indentScriptBlock(a,E.html_beautify(o,l))}`;let d=o.substring(c.length,o.length);return`${this.indentScriptBlock(a,E.html_beautify(c,l))}${d}`})}restoreHtmlAttributes(e){return r.replace(e,new RegExp(`${this.getHtmlAttributePlaceholder("(\\d+)")}`,"gms"),(t,n)=>this.htmlAttributes[n])}restoreXData(e){return r.replace(e,new RegExp(`${this.getXDataPlaceholder("(\\d+)")}`,"gm"),(t,n)=>{var u;let i=this.getXDataPlaceholder(n.toString()),s=(u=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?u:[""],a=v(s[0]),l=this.formatJS(this.xData[n]).split(`
`),o=a.amount/(this.indentCharacter==="	"?4:1),c=l[0],d=this.indentCharacter.repeat(o<0?0:o),p=l.map(g=>d+g);return p[0]=c,`${p.join(`
`)}`})}restoreXInit(e){return r.replace(e,new RegExp(`${this.getXInitPlaceholder("(\\d+)")}`,"gm"),(t,n)=>{var u;let i=this.getXInitPlaceholder(n.toString()),s=(u=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?u:[""],a=v(s[0]),l=this.formatJS(this.xInit[n]).split(`
`),o=a.amount/(this.indentCharacter==="	"?4:1),c=l[0],d=this.indentCharacter.repeat(o<0?0:o),p=l.map(g=>d+g);return p[0]=c,`${p.join(`
`)}`})}restoreTemplatingString(e){return r.replace(e,new RegExp(`${this.getTemplatingStringPlaceholder("(\\d+)")}`,"gms"),(t,n)=>this.templatingStrings[n])}restoreStringLiteralInPhp(e){return r.replace(e,new RegExp(`${this.getStringLiteralInPhpPlaceholder("(\\d+)")}`,"gms"),(t,n)=>this.stringLiteralInPhp[n])}restoreComponentAttribute(e){return r.replace(e,new RegExp(`${this.getComponentAttributePlaceholder("(\\d+)")}`,"gim"),(t,n)=>{var c;let i=this.getComponentAttributePlaceholder(n),s=(c=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?c:[""],a=v(s[0]),l=this.componentAttributes[n],o=r.replace(l,/(:{1,2}.*?=)(["'])(.*?)(?=\2)/gis,(d,p,u,g)=>{if(g==="")return d;if(p.startsWith("::"))return`${p}${u}${E.js_beautify(g,{wrap_line_length:this.wrapLineLength-a.amount,brace_style:"preserve-inline"}).trim()}`;if(this.isInline(g))try{return`${p}${u}${x(g,{...this.options,printWidth:this.wrapLineLength-a.amount}).trimEnd()}`}catch{return`${p}${u}${g}`}return`${p}${u}${x(g,{...this.options,printWidth:this.wrapLineLength-a.amount}).trimEnd()}`});return`${this.indentComponentAttribute(a.indent,o)}`})}restoreShorthandBinding(e){return r.replace(e,new RegExp(`${this.getShorthandBindingPlaceholder("(\\d+)")}`,"gms"),(t,n)=>{var c;let i=this.getShorthandBindingPlaceholder(n),s=(c=e.match(new RegExp(`^(.*?)${i}`,"gmi")))!=null?c:[""],a=v(s[0]),l=this.shorthandBindings[n],o=r.replace(l,/(:{1,2}.*?=)(["'])(.*?)(?=\2)/gis,(d,p,u,g)=>{let $={wrap_line_length:this.wrapLineLength-a.amount,brace_style:"preserve-inline"};if(g==="")return d;if(this.isInline(g))try{return`${p}${u}${E.js_beautify(g,$).trimEnd()}`}catch{return`${p}${u}${g}`}return`${p}${u}${E.js_beautify(g,$).trimEnd()}`});return`${this.indentComponentAttribute(a.indent,o)}`})}async formatAsBlade(e){this.currentIndentLevel=0,this.shouldBeIndent=!1;let t=j(e),n=await new U(this.vsctm,this.oniguruma);return n.createRegistry(e).loadGrammar("text.html.php.blade").then(a=>n.tokenizeLines(t,a)).then(a=>this.formatTokenizedLines(t,a)).catch(a=>{throw a})}formatTokenizedLines(e,t){this.result=[],this.stack=[];for(let n=0;n<e.length;n+=1){let i=e[n],s=t[n];this.processLine(s,i)}return this.result.join(this.endOfLine)}processLine(e,t){this.processTokenizeResult(e,t)}processKeyword(e){if(r.includes(k,e)){r.last(this.stack)==="@case"&&e==="@case"&&this.decrementIndentLevel(),e==="@case"&&(this.shouldBeIndent=!0),this.stack.push(e);return}if(r.includes(z,e)){if(e==="@break"){this.decrementIndentLevel(),this.stack.pop(),this.stack.push(e);return}if(r.last(this.stack)!=="@hassection"){this.stack.pop();return}}if(r.includes(oe,e)&&(this.shouldBeIndent=!0,this.stack.push(e)),r.includes(G,e)&&r.includes(ae,r.last(this.stack))&&(this.decrementIndentLevel(),this.shouldBeIndent=!0),r.includes(P,e)&&(r.last(this.stack)==="@section"&&e==="@section"?(this.currentIndentLevel>0&&this.decrementIndentLevel(),this.shouldBeIndent=!0,this.stack.push(e)):(this.shouldBeIndent=!0,this.stack.push(e))),r.includes(I,e)){if(e==="@endswitch"&&r.last(this.stack)==="@default"){this.decrementIndentLevel(2),this.shouldBeIndent=!1;return}this.decrementIndentLevel(),this.shouldBeIndent=!1,this.stack.pop()}r.includes(R,e)&&(this.decrementIndentLevel(),this.shouldBeIndent=!0)}processToken(e,t){if(r.includes(e.scopes,"punctuation.definition.comment.begin.blade")&&(this.isInsideCommentBlock=!0),this.argumentCheck){let{count:n,inString:i,stack:s}=this.argumentCheck;if(!i&&t===")"){if(s.push(t),n[t]+=1,n["("]===n[t]){let a=s.join("");de(a)>=this.argumentCheck.unindentOn&&(this.shouldBeIndent=!1),this.argumentCheck=!1}return}s.push(t),i===t?this.argumentCheck.inString=!1:!i&&(t==='"'||t==="'")&&(this.argumentCheck.inString=t),t==="("&&!i&&(n[t]+=1)}r.includes(e.scopes,"punctuation.definition.comment.end.blade")&&(this.isInsideCommentBlock=!1),(t==="{{--"||t.includes("{{--"))&&(this.isInsideCommentBlock=!0),(t==="--}}"||t.includes("--}}"))&&(this.isInsideCommentBlock=!1),r.includes(e.scopes,"keyword.blade")&&(this.isInsideCommentBlock||(this.processKeyword(t.toLowerCase()),r.includes(Object.keys(Q),t.toLowerCase())&&(this.argumentCheck={unindentOn:Q[t.toLowerCase()],stack:[],inString:!1,count:{"(":0,")":0}})))}processTokenizeResult(e,t){if(this.shouldBeIndent&&(this.incrementIndentLevel(),this.shouldBeIndent=!1),ce(e,t)){this.insertFormattedLineToResult(t);return}for(let n=0;n<e.tokens.length;n+=1){let i=e.tokens[n],s=t.substring(i.startIndex,i.endIndex).trim();this.processToken(i,s)}this.insertFormattedLineToResult(t)}insertFormattedLineToResult(e){let n=v(e).amount+this.indentSize*this.currentIndentLevel,i=this.indentCharacter.repeat(n<0?0:n)+e.trim();e.length===0&&this.result.push(e),e.length!==0&&i.length>0&&this.result.push(i),i!==e&&this.diffs.push({original:e,formatted:i})}incrementIndentLevel(e=1){this.currentIndentLevel+=e}decrementIndentLevel(e=1){this.currentIndentLevel-=e}formatExpressionInsideBladeDirective(e,t,n=void 0){let i=`func(${e})`,s=x(i,{...this.options,printWidth:n!=null?n:this.defaultPhpFormatOption.printWidth});if(s===i)return e;let a=s.replace(/([\n\s]*)->([\n\s]*)/gs,"->").replace(/(?<!(['"]).*)(?<=\()[\n\s]+?(?=\w)/gm,"").replace(/([^]*)],[\n\s]*?\)$/gm,(l,o)=>`${o}]
)`).replace(/,[\n\s]*?\)/gs,")").replace(/,(\s*?\))$/gm,(l,o)=>o).trim();return this.options.useTabs&&(a=r.replace(a,/(?<=^ *) {4}/gm,"	".repeat(this.indentSize))),a=a.replace(/func\((.*)\)/gis,(l,o)=>o),this.isInline(a.trim())&&(a=a.trim()),this.indentRawPhpBlock(t,a)}formatJS(e){let t=e,n={js:[],entangle:[]};return Object.keys(n).forEach(i=>{t=t.replace(new RegExp(`@${i}\\((?:[^)(]+|\\((?:[^)(]+|\\([^)(]*\\))*\\))*\\)`,"gs"),s=>{let a=n[i].push(s)-1;return this.getPlaceholder(i,a,s.length)})}),t=E.js_beautify(t,{brace_style:"preserve-inline"}),Object.keys(n).forEach(i=>{t=t.replace(new RegExp(this.getPlaceholder(i,"_*(\\d+)"),"gms"),(s,a)=>n[i][a])}),t}};import Me from"ajv";import Ue from"find-config";import Ve from"fs";import Ke from"path";var Qe=new Me,$e=[".bladeformatterrc.json",".bladeformatterrc"];function be(h){for(let e=0;e<$e.length;e+=1){let t=Ue($e[e],{cwd:Ke.dirname(h),home:!1});if(t)return t}return null}async function Se(h){if(h===null)return;let e=JSON.parse((await Ve.promises.readFile(h)).toString()),t={type:"object",properties:{indentSize:{type:"integer",nullable:!0},wrapLineLength:{type:"integer",nullable:!0},wrapAttributes:{type:"string",enum:["auto","force","force-aligned","force-expand-multiline","aligned-multiple","preserve","preserve-aligned"],nullable:!0},wrapAttributesMinAttrs:{type:"integer",nullable:!0,default:2},indentInnerHtml:{type:"boolean",nullable:!0},endWithNewline:{type:"boolean",nullable:!0},endOfLine:{type:"string",enum:["LF","CRLF"],nullable:!0},useTabs:{type:"boolean",nullable:!0},sortTailwindcssClasses:{type:"boolean",nullable:!0},tailwindcssConfigPath:{type:"string",nullable:!0},sortHtmlAttributes:{type:"string",enum:["none","alphabetical","code-guide","idiomatic","vuejs","custom"],nullable:!0},customHtmlAttributesOrder:{type:"array",nullable:!0,items:{type:"string"},default:[]},noMultipleEmptyLines:{type:"boolean",nullable:!0},noPhpSyntaxCheck:{type:"boolean",nullable:!0},noSingleQuote:{type:"boolean",nullable:!0},extraLiners:{type:"array",nullable:!0,items:{type:"string"},default:["head","body","/html"]}},additionalProperties:!0},n=Qe.compile(t);if(!n(e))throw n;return e}var V=class{constructor(e={},t=[]){var n;this.currentTargetPath=".",this.paths=t,this.options=e,this.targetFiles=[],this.errors=[],this.diffs=[],this.outputs=[],this.formattedFiles=[],this.ignoreFile="",this.fulFillFiles=[],this.targetFiles=[],this.runtimeConfigPath=(n=e.runtimeConfigPath)!=null?n:null,this.runtimeConfigCache={}}async format(e,t={}){this.options=this.options||t;let n=B.resolve(m.cwd(),"target");return await this.readIgnoreFile(n),await this.findTailwindConfig(n),await this.readRuntimeConfig(n),new T(this.options).formatContent(e).catch(i=>{throw new O(i)})}async formatFromCLI(){try{this.printPreamble(),await this.readIgnoreFile(m.cwd()),await this.processPaths(),this.printResults()}catch{}}fileExists(e){return W.promises.access(e,W.constants.F_OK).then(()=>!0).catch(()=>!1)}async readIgnoreFile(e){let t=".bladeignore",n,i=B.dirname(e);if(this.options.ignoreFilePath?n=this.options.ignoreFilePath:n=xe(t,{cwd:i}),!!n)try{this.ignoreFile=(await W.promises.readFile(n)).toString()}catch{}}async findTailwindConfig(e){if(!this.options.sortTailwindcssClasses)return;let t="tailwind.config.js",n;if(this.options.tailwindcssConfigPath)if(this.runtimeConfigPath){let i=B.dirname(this.runtimeConfigPath);n=B.resolve(i,this.options.tailwindcssConfigPath)}else B.isAbsolute(this.options.tailwindcssConfigPath)?n=B.resolve(this.options.tailwindcssConfigPath):n=B.resolve(this.options.tailwindcssConfigPath);else{let i=B.dirname(e);n=xe(t,{cwd:i})}n&&(this.options.tailwindcssConfigPath=n)}async readRuntimeConfig(e){var n,i;_.isEmpty(this.runtimeConfigCache)&&(this.options=_.merge(this.options,this.runtimeConfigCache));let t;if(this.options.runtimeConfigPath?t=this.options.runtimeConfigPath:t=be(e),!_.isNull(t)){this.runtimeConfigPath=t;try{let s=await Se(t);this.options=_.mergeWith(this.options,s,(a,l)=>_.isNil(l)?a:l),this.runtimeConfigCache=this.options,this.options.sortTailwindcssClasses&&await this.findTailwindConfig(e)}catch(s){s instanceof SyntaxError&&(m.stdout.write(b.red.bold(`
...
`),(n=s.errors[0].params)!=null&&n.allowedValues&&console.log((i=s.errors[0].params)==null?void 0:i.allowedValues),m.exit(1)}}}async processPaths(){await Promise.all(_.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await V.globFiles(e).then(t=>_.map(t,n=>B.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{Ze(e,(i,s)=>i?n(i):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=_.filter(e,a=>t.test(B.relative(".",a))),i=_.xor(e,n),s=Ge().add(this.ignoreFile).filter(i);return _.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(_.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.findTailwindConfig(e),await this.readRuntimeConfig(e),await X(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new T(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=W.readFileSync(e,"utf-8"),i=j(n),s=j(t),a=ge(e,i,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&m.stdout.write(b.green("F")),this.options.checkFormatted&&(m.stdout.write(`${e}
