...
`;
    ...
    test('it does not eat email addresses', () => {
        ...
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(input).trim(), input);
        input = `<a 
...
`;
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(template), expected);
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(expected), expected);
    });
...
`;
        ...
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(output), output);
    });
...
`;
        assert_1.default.strictEqual((0, utils_1.formatBladeString)(template), output);
    });
...
//# sourceMappingURL=formatter_templates.test.js.map