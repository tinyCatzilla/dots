...
suite('Pint Transformer Acceptance: admin_resources_views_components_footer_blade_php', () => {
    test('pint: it can format admin_resources_views_components_footer_blade_php', () => {
        const input = `{{ \\Filament\\Facades\\Filament::renderHook('footer.before') }}
...
`;
        const output = `{{ \\Filament\\Facades\\Filament::renderHook('footer.before') }}
...
//# sourceMappingURL=admin_resources_views_components_footer_blade_php.test.js.map