...
suite('Pint Transformer Acceptance: admin_resources_views_widgets_filament_info_widget_blade_php', () => {
    test('pint: it can format admin_resources_views_widgets_filament_info_widget_blade_php', () => {
        const input = `<x-filament::widget class="filament-filament-info-widget">
    <x-filament::card class="relative">
        <div class="relative h-12 flex flex-col justify-center items-center space-y-2">
            <div class="space-y-1">
                ...
                >
                    <svg role="img" aria-label="Filament" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 303 61" class="fill-current w-24 h-6">
...
`;
        const output = `<x-filament::widget class="filament-filament-info-widget">
    <x-filament::card class="relative">
        <div
        ...
        >
            <div class="space-y-1">
                <a
                    ...
                    rel="noopener noreferrer"
                    @class([
                        'hover:text-primary-500 flex items-end space-x-2 text-gray-800 transition rtl:space-x-reverse',
                        'dark:text-primary-500 dark:hover:text-primary-400' => config('filament.dark_mode'),
                    ])
                >
                    <svg
...
//# sourceMappingURL=admin_resources_views_widgets_filament_info_widget_blade_php.test.js.map