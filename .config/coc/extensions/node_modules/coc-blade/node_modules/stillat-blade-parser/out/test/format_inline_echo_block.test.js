...
function formatBladeStringInlineEcho(content) {
    const options = optionDiscovery_1.defaultSettings;
    return (0, utils_1.formatBladeString)(content, {
        ...options,
        echoStyle: 'inline'
    });
}
suite('Inline Echo Formatting', () => {
    test('it formats valid PHP code', () => {
        assert_1.default.strictEqual(formatBladeStringInlineEcho('{{$test   +$that}}').trim(), '{{ $test + $that }}');
    });
    ...
    test('it formats php without crashing', () => {
        ...
        assert_1.default.strictEqual(formatBladeStringInlineEcho(input).trim(), out);
    });
    test('it ignores invalid PHP code in {{{', () => {
        assert_1.default.strictEqual(formatBladeStringInlineEcho('{{{$test   $+++$that}}}').trim(), '{{{ $test   $+++$that }}}');
    });
...
>
    Some link
        ...
        assert_1.default.strictEqual(formatBladeStringInlineEcho(input).trim(), expected);
    });
    test('it can format inline echos as text', () => {
        assert_1.default.strictEqual(formatBladeStringInlineEcho(`
            <p>test {{ $title }} test
...
></label>
`;
        assert_1.default.strictEqual(formatBladeStringInlineEcho(input), out);
    });
...
`;
        assert_1.default.strictEqual(formatBladeStringInlineEcho(input), out);
        assert_1.default.strictEqual(formatBladeStringInlineEcho(out), out);
    });
...
></div>`;
        assert_1.default.strictEqual(formatBladeStringInlineEcho(template).trim(), out);
    });
...
`;
        assert_1.default.strictEqual(formatBladeStringInlineEcho(input), output);
    });
...
//# sourceMappingURL=format_inline_echo_block.test.js.map