...
suite('Pint Transformer: Directives', () => {
    test('pint: it can format PHP in directives', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`@directive   ($test  + $that-$another   + $thing)`).trim(), `@directive($test + $that - $another + $thing)`);
    });
    test('pint: it preserves content if PHP is invalid', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`@directive   ($test  ++++ $that-$another   + $thing)`).trim(), `@directive($test  ++++ $that-$another   + $thing)`);
    });
    test('pint: it indents nicely', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`@section("messages")
...
@show`);
    ...
    test('pint: it preserves same line if HTML is on same line', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`<div>@directive   ($test  + $that-$another   + $thing)</div>`).trim(), `<div>@directive($test + $that - $another + $thing)</div>`);
    });
...
`;
    ...
    <span @class([
        ...
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(input2), out);
    });
...
`;
        ...
        assert_1.default.strictEqual(result, out);
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(result), out);
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)((0, utils_1.formatBladeStringWithPint)(result)), out);
    });
});
//# sourceMappingURL=formatter_pint_directives.test.js.map