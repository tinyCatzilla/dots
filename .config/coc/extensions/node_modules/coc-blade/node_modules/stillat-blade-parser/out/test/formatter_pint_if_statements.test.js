...
suite('Pint Transformer: If Statements', () => {
    test('pint: it can format if statements without any HTML hints', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`@if($true)
...
@endif`);
    ...
    test('pint: it can format without an else', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`@if($true)
            Thing
                        @elseif($anotherValue) More Things @endif`).trim(), `@if ($true)
    Thing
@elseif ($anotherValue)
    More Things
@endif`);
...
//# sourceMappingURL=formatter_pint_if_statements.test.js.map