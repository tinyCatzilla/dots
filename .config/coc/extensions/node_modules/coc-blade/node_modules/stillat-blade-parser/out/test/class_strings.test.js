...
@endphp
`;
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(input, {
            ...optionDiscovery_1.defaultSettings,
            classStrings: (0, classStringsConfig_1.classConfigFromObject)({
                enabled: false
            })
        }), expected);
    });
...
//# sourceMappingURL=class_strings.test.js.map