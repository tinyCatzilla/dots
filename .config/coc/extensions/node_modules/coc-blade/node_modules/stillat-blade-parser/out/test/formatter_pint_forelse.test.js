...
@endforelse
    ...
    test('pint: it can unwrap forelse from a single line', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`<div> @forelse ($users as $user) <li>{{ $user->name }}</li> @empty <p>No users</p> @endforelse</div> `).trim(), `<div>
    @forelse ($users as $user)
        <li>{{ $user->name }}</li>
    @empty
        <p>No users</p>
...
//# sourceMappingURL=formatter_pint_forelse.test.js.map