...
`;
    ...
    test('pint: it does not eat email addresses', () => {
        ...
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(input).trim(), input);
        input = `<a 
...
`;
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(template), expected);
...
`;
        ...
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(output), output);
    });
...
`;
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(template), output);
    });
});
//# sourceMappingURL=formatter_pint_templates.test.js.map