...
`;
    ...
    test('pint: it indents php blocks', () => {
        assert_1.default.strictEqual((0, utils_1.formatBladeStringWithPint)(`<main class="index">
<div>
        {{--
 Block Comment.
...
//# sourceMappingURL=formatter_pint_php_blocks.test.js.map